...
{
	public class ServiceSettingsManager : ConfigurationSection
	{
		...
		[ConfigurationProperty("picturesOnDisk")]
		[StringValidator(InvalidCharacters = "~!@#$%^&*()[]{}/;'\"|")]
		public String picturesOnDisk
		{
			get
			{
				return (string)this["picturesOnDisk"];
			}
			set
			{
				this["picturesOnDisk"] = value;
			}
		}
